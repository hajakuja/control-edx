...
String config_message_7_bytes = "&A~Desired~5&C&S~K_P~P~0~10~0.05&S~Direct~O~0~260~0.01&S~Desired~A~0~260~1&T~MotorSpeed~U1~0~260&T~Error~S1~-150~150&T~MotorCmd~U1~0~260&H~2&";
...
void loop() {
  ...
  if (loop_counter % numSkip == 0) {
    loop_counter = 0;
    printStatus(motorSpd, int(error), motorCmd, headroom);
  }
